...
function control() {
  var contBtn = document.querySelector(".control-btn");

  var _document$querySelect = document.querySelector(".control"),
      childNodes = _document$querySelect.childNodes;

  var _childNodes = _slicedToArray(childNodes, 2),
      _add = _childNodes[0],
      _update = _childNodes[1];

  var obj = {
    add: function add() {
      _add.classList.toggle("show");
    },
    update: function update() {
      _update.classList.toggle("show");
    }
  };
  contBtn.addEventListener("click", function (e) {
    if (e.target.getAttribute("control") === "work") {
      changeState.apply(void 0, _toConsumableArray(e.target.classList));
      return "";
    }
  ...
  function hide(item) {
    ...
    (_item$classList = item.classList) === null || _item$classList === void 0 ? void 0 : _item$classList.remove("show");
  }
}
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": function() { return /* binding */ createObj; }
/* harmony export */ });
/* harmony import */ var core_js_modules_es_object_to_string_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/modules/es.object.to-string.js */ "./node_modules/core-js/modules/es.object.to-string.js");
/* harmony import */ var core_js_modules_es_object_to_string_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_object_to_string_js__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var core_js_modules_web_dom_collections_for_each_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! core-js/modules/web.dom-collections.for-each.js */ "./node_modules/core-js/modules/web.dom-collections.for-each.js");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _formObject__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./formObject */ "./src/js/formObject.js");
...
function deleteElement() {
  ...
  books.addEventListener("click", function (e) {
    if (e.target.classList.contains("delete")) {
      var id = e.target.parentElement.firstElementChild.dataset.id;
      _formObject__WEBPACK_IMPORTED_MODULE_0__["default"]["delete"](id);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": function() { return /* binding */ formControl; }
/* harmony export */ });
/* harmony import */ var _formObject__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./formObject */ "./src/js/formObject.js");
...
function formControl() {
  ...
  ref.addForm.addEventListener("submit", _formObject__WEBPACK_IMPORTED_MODULE_0__["default"].add.bind(_formObject__WEBPACK_IMPORTED_MODULE_0__["default"]));
  ref.updateForm.addEventListener("submit", _formObject__WEBPACK_IMPORTED_MODULE_0__["default"].update.bind(_formObject__WEBPACK_IMPORTED_MODULE_0__["default"]));
}

/***/ }),

/***/ "./src/js/formObject.js":
/*!******************************!*\
  !*** ./src/js/formObject.js ***!
  \******************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var notiflix__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! notiflix */ "./node_modules/notiflix/dist/notiflix-aio-3.2.5.min.js");
/* harmony import */ var notiflix__WEBPACK_IMPORTED_MODULE_21___default = /*#__PURE__*/__webpack_require__.n(notiflix__WEBPACK_IMPORTED_MODULE_21__);
/* harmony import */ var _createObj__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ./createObj */ "./src/js/createObj.js");
...
var render = (__webpack_require__(/*! ./render/render */ "./src/js/render/render.js")["default"]);

var utilitiesObj = (__webpack_require__(/*! ./utilities */ "./src/js/utilities.js")["default"]);

var BASE = "http://localhost:4000/books";
var formObject = {
  add: function add(e) {
    return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
      var data, _yield$utilitiesObj$c, bool, response;
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              e.preventDefault();
              data = (0,_createObj__WEBPACK_IMPORTED_MODULE_22__["default"])(_toConsumableArray(e.target.elements).filter(function (item) {
                return item.tagName === "INPUT" || item.tagName === "TEXTAREA";
              })); // console.log(utilitiesObj)

              _context.next = 4;
              return utilitiesObj.checkIs(data);

            case 4:
              _yield$utilitiesObj$c = _context.sent;
              bool = _yield$utilitiesObj$c.bool;
              ...
              _context.prev = 7;
              _context.next = 10;
              return fetch(BASE, utilitiesObj.setting("POST", data));
            ...
            case 16:
              ...
              notiflix__WEBPACK_IMPORTED_MODULE_21__.Notify.failure(_context.t0);
            ...
            case 21:
              notiflix__WEBPACK_IMPORTED_MODULE_21__.Notify.failure("Element is already created");
  ...
  update: function update(e) {
    return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
      var data, _yield$utilitiesObj$c2, bool, id, response;
      ...
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 4:
              _yield$utilitiesObj$c2 = _context2.sent;
              bool = _yield$utilitiesObj$c2.bool;
              id = _yield$utilitiesObj$c2.id;
              ...
              _context2.prev = 8;
              _context2.next = 11;
              return fetch("".concat(BASE, "/").concat(id), utilitiesObj.setting("PATCH", data));
            ...
            case 17:
              ...
              notiflix__WEBPACK_IMPORTED_MODULE_21__.Notify.failure(_context2.t0);
            ...
            case 22:
              notiflix__WEBPACK_IMPORTED_MODULE_21__.Notify.failure("Element wasn`t created");
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              _context3.prev = 0;
              _context3.next = 3;
              return fetch("".concat(BASE, "/").concat(id), utilitiesObj.setting("DELETE"));
            ...
            case 8:
              ...
              notiflix__WEBPACK_IMPORTED_MODULE_21__.Notify.failure(_context3.t0);
...
/* harmony default export */ __webpack_exports__["default"] = (formObject); //  http://localhost:4000/books

/***/ }),

/***/ "./src/js/render/createCardBook.js":
/*!*****************************************!*\
  !*** ./src/js/render/createCardBook.js ***!
  \*****************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": function() { return /* binding */ createCardBook; }
/* harmony export */ });
...
function createCardBook(book) {
  ...
  return "<div class=\"books__item\">\n      <div class=\"books__name\" data-id=".concat(id, "><span>name:</span>").concat(name, "</div>\n      <div class=\"books__rating\"><span>rating:</span>").concat(rating, "</div>\n      <div class=\"books__describe\">\n        ").concat(describe, "\n      </div>\n      <button class=\"delete\">delete</button>\n      </div>");
}
...
/* harmony import */ var _createCardBook__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./createCardBook */ "./src/js/render/createCardBook.js");
...
function render() {
  ...
  fetch("http://localhost:4000/books").then(function (responce) {
    if (!responce.ok) {
      throw new Error("");
    }
    ...
    refs.listBook.insertAdjacentHTML("beforeend", data.map(_createCardBook__WEBPACK_IMPORTED_MODULE_4__["default"]).join(""));
  });
}
...
/* harmony import */ var notiflix__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! notiflix */ "./node_modules/notiflix/dist/notiflix-aio-3.2.5.min.js");
/* harmony import */ var notiflix__WEBPACK_IMPORTED_MODULE_20___default = /*#__PURE__*/__webpack_require__.n(notiflix__WEBPACK_IMPORTED_MODULE_20__);
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
...
var BASE = "http://localhost:4000/books";
var utilitiesObj = {
  setting: function setting(type, data) {
    return {
      method: type,
  ...
  checkIs: function checkIs(fetchData) {
    return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
      var response, books, _iterator, _step, book;
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 27:
              ...
              notiflix__WEBPACK_IMPORTED_MODULE_20__.Notify.failure(_context.t1);
      ...
      }, _callee, null, [[0, 27], [8, 18, 21, 24]]);
    }))();
  }
};
/* harmony default export */ __webpack_exports__["default"] = (utilitiesObj);
...
window.addEventListener("DOMContentLoaded", function () {
  var control = (__webpack_require__(/*! ./control */ "./src/js/control.js")["default"]);

  var render = (__webpack_require__(/*! ./render/render */ "./src/js/render/render.js")["default"]);

  var formControl = (__webpack_require__(/*! ./formControl */ "./src/js/formControl.js")["default"]);

  var deleteElement = (__webpack_require__(/*! ./deleteElement */ "./src/js/deleteElement.js")["default"]);
